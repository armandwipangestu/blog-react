        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-search">
          ...
          <ul class="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <li>
              <a
                href="#"
                class="block py-2 pr-4 pl-3 text-gray-400/70 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-gray-500/70 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
              >
                About
              </a>
            </li>
